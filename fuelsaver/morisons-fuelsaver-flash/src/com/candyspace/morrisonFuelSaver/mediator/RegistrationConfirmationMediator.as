...
package com.candyspace.morrisonFuelSaver.mediator
{
	 ...
	 * Class Comment
	 */
	public class RegistrationConfirmationMediator extends SuperOneButtonMediator
	{
		// --------------------------------------
		// Properties
		// --------------------------------------
		...
		{
			return getQualifiedClassName(RegistrationConfirmationMediator);
		}
		...
		public function RegistrationConfirmationMediator(viewComponent:Object = null)
		{
			super(RegistrationConfirmationMediator.NAME, viewComponent);
		}
